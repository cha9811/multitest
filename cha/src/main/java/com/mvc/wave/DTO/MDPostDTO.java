...
public class MDPostDTO {
	...
	private MultipartFile MD_post_Thumbnail;
	...
	public MultipartFile getMD_post_Thumbnail() {
		return MD_post_Thumbnail;
	}

	public void setMD_post_Thumbnail(MultipartFile mD_post_Thumbnail) {
		MD_post_Thumbnail = mD_post_Thumbnail;
	}

	@Override
	public String toString() {
		return "MDPostDTO [MD_id=" + MD_id + ", MD_title=" + MD_title + ", content=" + content + ", MD_create="
